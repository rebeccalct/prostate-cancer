   ...
   encoded_vars : dict
    ...
    def transform_data(self, generated_samples) :
        ...
        for col in self.categorical_columns : 
            ...
            regex_pattern = '^' + escaped_col
            #get the obtained numerical values of each categorical attribute encoded group
            cols_drop = (generated_samples.filter(regex=regex_pattern)).columns.tolist()
            values = generated_samples.filter(regex=regex_pattern).values
